...
public interface IGenericDataService<T>
{
    ...
    Task<string> Get(ClaimsPrincipal user, string controllerName, int? page = null, int pageSize = 10, string sortProperty = null, string sortOrder = "ASC", IComparerObjectGroup filterObject = null, SummaryRequestObject[] summaries = null);

    Task<string> Get(ClaimsPrincipal user, Endpoint endpoint, int? page = null, int pageSize = 10, string sortProperty = null, string sortOrder = "ASC", IComparerObjectGroup filterObject = null);
